...
|----------|--------|------------|
| **[44 - Паспорт приложения…](./44%20-%20Паспорт%20приложения%20и%20экспериментальная%20эксплуатация%20(v0.9.1).pdf)** | PDF | Паспорт, эксплуатация, боевой опыт, требования |
...
Ключевые заметки: 40 (LLM), 41 (боевой опыт), 43 (боевой запуск), 44 (паспорт).
...
- Боевой запуск: `install.ps1`, `prepare-battle-db`, zip + `app.db`
- LLM Ollama opt-in (`llama3.2`), GUI settings scroll
- Пакет боевого опыта export/import
- GUI под 1920×1080
