...
## Статус v0.5.0 (2026-07-02)

- **Заявка на испытания:** `application_generator.py`, шаблон `data/templates/zayavka_ispytaniy.docx`
- **Заказы:** `orders.application_path`, кнопки в GUI, `generate-application` в CLI
- **GUI:** обновлённый дизайн, русское название окна
...
| [[18 — Заявка на испытания (Word)]] | Генерация заявки |
| [[19 — Запуск приложения]] | Установка и запуск GUI |
| [[20 — Письма и NLP (PyTorch)]] | Письма, СПЕЦЛАН, NER |
